...
basebar <- basebar + geom_text(
  ...
  aes(x = Year_Quarter, 
      ...
      hjust = 1,
      label = Total_RTR),
  family="Tahoma", # set the font family
  size=4.7, # slightly adjust the label size
  fontface="bold",
  color="white"
  )
...
We've also set the font family for the bar labels, and added a new color scale with __basebar <- basebar + scale_colour_few(palette="medium") + scale_fill_few(palette="medium")__
